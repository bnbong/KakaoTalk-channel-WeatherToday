...
class TestInnerAPI():
    ...
    def setup_class(cls):
        ...
        try:
            ...
            cls.client.post('/api/v1/create-kakao-user', json={'user_name':'TestUser0', 'user_time':'1000','user_location':'TestLocation0'})
    ...
    def test_create_kakao_user(self):
        response = self.client.post('/api/v1/create-kakao-user', json={'user_name':'NewUser1', 'user_location':'NewLocation1'})
    ...
    def test_edit_user_location(self):
        response = self.client.put('/api/v1/edit-user-location', json={'user_name':'NewUser1','user_location':'NewLocation2'})
